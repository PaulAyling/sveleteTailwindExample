<script>
    ...
    import Card from '../17_RecursiveWithStoreOnly/card.svelte'
    const map=
            {
             1:{
                'componentId':1,
...
<main>
    <h1>PURPOSE</h1>
    <p>components store will be used as a store in all components (not sent via prop)</p>
    <Card id={startingId} map={map} authenticatedUser={authenticatedUser}/>
